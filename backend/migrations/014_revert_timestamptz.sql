...
-- Version: 014-revert
-- Date: 2026-01-18
-- Description: Revert TIMESTAMPTZ back to TIMESTAMP to fix sqlx compile issues
-- ============================================
...
-- Users table
ALTER TABLE users ALTER COLUMN email_verified_at TYPE TIMESTAMP USING email_verified_at AT TIME ZONE 'UTC';
...
-- Spaces table
ALTER TABLE spaces ALTER COLUMN created_at TYPE TIMESTAMP USING created_at AT TIME ZONE 'UTC';
ALTER TABLE spaces ALTER COLUMN updated_at TYPE TIMESTAMP USING updated_at AT TIME ZONE 'UTC';

-- Space memberships table
ALTER TABLE space_memberships ALTER COLUMN joined_at TYPE TIMESTAMP USING joined_at AT TIME ZONE 'UTC';

-- Documents table
ALTER TABLE documents ALTER COLUMN archived_at TYPE TIMESTAMP USING archived_at AT TIME ZONE 'UTC';
ALTER TABLE documents ALTER COLUMN created_at TYPE TIMESTAMP USING created_at AT TIME ZONE 'UTC';
ALTER TABLE documents ALTER COLUMN updated_at TYPE TIMESTAMP USING updated_at AT TIME ZONE 'UTC';

-- Document versions table
ALTER TABLE document_versions ALTER COLUMN created_at TYPE TIMESTAMP USING created_at AT TIME ZONE 'UTC';

-- Files table
ALTER TABLE files ALTER COLUMN deleted_at TYPE TIMESTAMP USING deleted_at AT TIME ZONE 'UTC';
ALTER TABLE files ALTER COLUMN created_at TYPE TIMESTAMP USING created_at AT TIME ZONE 'UTC';

-- Comments table
ALTER TABLE comments ALTER COLUMN resolved_at TYPE TIMESTAMP USING resolved_at AT TIME ZONE 'UTC';
...
-- Sync sessions table
ALTER TABLE sync_sessions ALTER COLUMN last_sync_at TYPE TIMESTAMP USING last_sync_at AT TIME ZONE 'UTC';
ALTER TABLE sync_sessions ALTER COLUMN expires_at TYPE TIMESTAMP USING expires_at AT TIME ZONE 'UTC';
ALTER TABLE sync_sessions ALTER COLUMN created_at TYPE TIMESTAMP USING created_at AT TIME ZONE 'UTC';

-- Share links table
ALTER TABLE share_links ALTER COLUMN expires_at TYPE TIMESTAMP USING expires_at AT TIME ZONE 'UTC';
ALTER TABLE share_links ALTER COLUMN created_at TYPE TIMESTAMP USING created_at AT TIME ZONE 'UTC';

-- Password resets table
ALTER TABLE password_resets ALTER COLUMN expires_at TYPE TIMESTAMP USING expires_at AT TIME ZONE 'UTC';
ALTER TABLE password_resets ALTER COLUMN used_at TYPE TIMESTAMP USING used_at AT TIME ZONE 'UTC';
ALTER TABLE password_resets ALTER COLUMN created_at TYPE TIMESTAMP USING created_at AT TIME ZONE 'UTC';

-- Refresh tokens table
ALTER TABLE refresh_tokens ALTER COLUMN expires_at TYPE TIMESTAMP USING expires_at AT TIME ZONE 'UTC';
ALTER TABLE refresh_tokens ALTER COLUMN revoked_at TYPE TIMESTAMP USING revoked_at AT TIME ZONE 'UTC';
...
-- Recreate all views with original timestamp columns
